...
class AddRequest final :
 ...
 public:
  ...
  void clear_lhs();
  int64_t lhs() const;
  void set_lhs(int64_t value);
  private:
  int64_t _internal_lhs() const;
  void _internal_set_lhs(int64_t value);
  public:

  // sint64 rhs = 2;
  void clear_rhs();
  int64_t rhs() const;
  void set_rhs(int64_t value);
  private:
  int64_t _internal_rhs() const;
  void _internal_set_rhs(int64_t value);
  public:
...
inline void AddRequest::clear_lhs() {
  _impl_.lhs_ = int64_t{0};
}
inline int64_t AddRequest::_internal_lhs() const {
  return _impl_.lhs_;
}
inline int64_t AddRequest::lhs() const {
  // @@protoc_insertion_point(field_get:novanet.example.calculator.AddRequest.lhs)
  return _internal_lhs();
}
inline void AddRequest::_internal_set_lhs(int64_t value) {
  
  _impl_.lhs_ = value;
}
inline void AddRequest::set_lhs(int64_t value) {
...
inline void AddRequest::clear_rhs() {
  _impl_.rhs_ = int64_t{0};
}
inline int64_t AddRequest::_internal_rhs() const {
  return _impl_.rhs_;
}
inline int64_t AddRequest::rhs() const {
  // @@protoc_insertion_point(field_get:novanet.example.calculator.AddRequest.rhs)
  return _internal_rhs();
}
inline void AddRequest::_internal_set_rhs(int64_t value) {
  
  _impl_.rhs_ = value;
}
inline void AddRequest::set_rhs(int64_t value) {
