...
public:
    ...
    [[nodiscard]] static std::string_view errorCodeToString(
        ...
        switch (code) {
            ...
            case RPC_PARSE_RESPONSE_FAILED:
                return "RPC_PARSE_RESPONSE_FAILED";
            case RPC_SERIALIZE_REQUEST_FAILED:
                return "RPC_SERIALIZE_REQUEST_FAILED";
            case RPC_CONNECTION_CLOSED:
                return "RPC_CONNECTION_CLOSED";
            case RPC_STREAM_PROTOCOL_ERROR:
                return "RPC_STREAM_PROTOCOL_ERROR";
            default:
    ...
    [[nodiscard]] static std::string_view defaultErrorText(
        ...
        switch (code) {
            ...
            case RPC_PARSE_RESPONSE_FAILED:
                return "failed to parse rpc response payload";
            case RPC_SERIALIZE_REQUEST_FAILED:
                return "failed to serialize rpc request payload";
            case RPC_CONNECTION_CLOSED:
                return "rpc connection closed";
            case RPC_STREAM_PROTOCOL_ERROR:
                return "rpc stream protocol error";
            default:
