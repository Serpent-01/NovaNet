...
public:
     ...
     */
    RpcMessage(FrameType type, uint32_t streamId, uint64_t requestId,
               std::string payload = {}, uint16_t flags = 0);
     ...
     *     makeHeartbeatPing()
     */
    static RpcMessage make(FrameType type, uint32_t streamId,
